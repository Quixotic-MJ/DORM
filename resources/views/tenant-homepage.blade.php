...
<body class="flex bg-gray-900"
    ...
    <div id="app" class="flex justify-between w-full">
            ...
            <section>
                ...
                <div class="grid grid-cols-4 gap-4 my-6 text-white">
                    ...
                    <div class="bg-gray-800 p-4 rounded-lg text-center">
                        ...
                        <p class="text-lg font-semibold">${{ number_format($totalPaid, 2) }}</p>
                    </div>
                </div>
                ...
                <section>
                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        <div
                            ...
                            <div>
                                <form action="{{ route('tenant.homepage') }}" method="GET" class="flex items-center space-x-4">
                                    <select name="date_filter" id="date_filter" onchange="this.form.submit()"
                                        ...
                                        <option value="last_day" {{ $dateFilter == 'last_day' ? 'selected' : '' }}>Last day</option>
                                        ...
                                        <option value="custom_range" {{ $dateFilter == 'custom_range' ? 'selected' : '' }}>Custom range</option>
                                    </select>

                                    <div id="custom-date-range" class="flex items-center space-x-2 {{ $dateFilter == 'custom_range' ? '' : 'hidden' }}">
                                        ...
                                        <input type="date" name="end_date" id="end_date"
                                            class="text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <button type="submit"
                                            class="px-3 py-1 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            Apply
                                        </button>
                                    </div>
                                </form>
        ...
        <script>
            // JavaScript for custom date range
            document.addEventListener('DOMContentLoaded', function() {
                const dateFilter = document.getElementById('date_filter');
                const customDateRange = document.getElementById('custom-date-range');

                // Show/hide custom date range inputs based on selected option
