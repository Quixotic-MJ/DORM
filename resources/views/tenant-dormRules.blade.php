            ...
            <section>
                ...
                <section class="bg-white dark:bg-gray-900">
                    <div class="container px-6 py-6 mx-auto">
                        <h1 class="text-2xl font-semibold text-gray-800 lg:text-3xl dark:text-white">Rules and
                            Regulations
                        </h1>

                        <!-- Scrollable container with fixed height -->
                        <div class="mt-6 max-h-[calc(100vh-200px)] overflow-y-auto scrollbar-hide">
                            <div class="pr-2 pb-4">
                                <!-- FAQ Item 1 -->
                                <div>
                                    <div>
                                        <pre class="mt-2 text-sm text-gray-500 dark:text-gray-300 whitespace-pre-wrap font-sans">
                                            {{ $rules }}
                                        </pre>
                                    </div>
                                </div>
