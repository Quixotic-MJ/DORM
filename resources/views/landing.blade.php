...
<body class="w-screen h-[100svh] bg-gray-800">
        ...
        <div class="mx-auto flex h-16 items-center gap-8 px-4 sm:px-6 lg:px-8">
            <a class="block text-teal-600" href="#">
                <div class="flex items-center space-x-2">
                    <img src="{{ asset('images/logo.png') }}" alt="Dormnest Logo" class="h-8 w-auto"/>
                </div>
            </a>
        ...
        <div class="relative z-10 mx-auto w-screen max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-32">
            <div class="mx-auto max-w-prose text-center">
                ...
                <div class="mt-4 flex justify-center gap-4 sm:mt-6">
                    <a class="inline-block rounded w-32 bg-[#ffc329] px-5 py-3 font-medium text-black shadow-sm transition-colors hover:text-[#ffc329] hover:bg-gray-900 cursor-pointer"
        ...
        <div class="container px-6 py-10 mx-auto">
            ...
            <div class="flex items-center justify-center">
                <div class="flex items-center p-1 border border-[#ffc329] rounded-xl">
                    <button
                        class="px-4 py-2 text-sm font-medium text-gray-900 capitalize bg-[#ffc329] md:py-3 rounded-xl md:px-12">
                        Frontend Developers
                    </button>
                    <button
                        class="px-4 py-2 mx-4 text-sm font-medium text-white capitalize transition-colors duration-300 md:py-3 focus:outline-none hover:bg-[#ffc329] hover:text-gray-900 rounded-xl md:mx-8 md:px-12">
                        Backend Developers
                    </button>
                    <button
                        class="px-4 py-2 text-sm font-medium text-white capitalize transition-colors duration-300 md:py-3 focus:outline-none hover:bg-[#ffc329] hover:text-gray-900 rounded-xl md:px-12">
                        Testers
                    </button>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
                <div class="flex flex-col items-center">
                    ...
                    <h1 class="mt-4 text-2xl font-semibold text-white capitalize dark:text-white">arthur melo</h1>
                ...
                <div class="flex flex-col items-center">
                    ...
                    <h1 class="mt-4 text-2xl font-semibold text-white capitalize dark:text-white">Pamela Anderson
                    </h1>
                ...
                <div class="flex flex-col items-center">
                    ...
                    <h1 class="mt-4 text-2xl font-semibold text-white capitalize dark:text-white">John Doe</h1>
